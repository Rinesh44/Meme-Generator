...
public class HandleMemeWriteBounds {
   ...
   static Bitmap meme_image, logo,logo2;

    public HandleMemeWriteBounds(Bitmap bitmap, Bitmap bitmap2,Bitmap bitmap3, Typeface font_style) {
    ...
    public Bitmap generateImage(String topText, String bottomText) {
        ...
        logo = ((BitmapDrawable) CreateMemeActivity.meme_generated_logo.getDrawable()).getBitmap();
        canvas.drawBitmap(logo,0, canvas.getHeight()-(logo.getHeight()),new Paint());

            logo2 = ((BitmapDrawable) CreateMemeActivity.meme_generated_logo2.getDrawable()).getBitmap();
            canvas.drawBitmap(logo2, canvas.getWidth() - logo2.getWidth(), canvas.getHeight() - logo2.getHeight(), new Paint());
